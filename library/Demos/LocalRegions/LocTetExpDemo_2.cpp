...
int main(int argc, char *argv[])
{
    if(argc != 5)
    {
        cerr << "usage: LocTetExpDemo MeshFile nummodes0 nummodes1 nummodes2" << endl;
        exit(1);
    }
    ...
    if(!(geom = boost::dynamic_pointer_cast<SpatialDomains::TetGeom>(graph3D.GetCompositeItem(0,0))))
    {
...
NekDouble Tet_sol(NekDouble x, NekDouble y, NekDouble z, int nummodes1, int nummodes2, int nummodes3)
{
    NekDouble sol = 0;
