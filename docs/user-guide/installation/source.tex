...
CMake $\geq 3.1.3$ & \cmark & \cmark & \cmark &        & Ncurses
GUI optional
\\
...
CMake $\geq 3.1.3$ & \cmark & \texttt{cmake}   & \cmark &        & Ncurses
GUI optional \\
BLAS            & \cmark &                  &        &        & Part of
Xcode \\
...
\midrule
MS Visual Studio  & \cmark & \cmark &              & 2013, 2015, 2017 and 2019 known working\\
CMake $\geq 3.1.3$  & \cmark & \cmark &              & \\
...
\begin{enumerate}
  ...
  \item Install CMake 3.1.3+ from \url{http://www.cmake.org/download/}. When
