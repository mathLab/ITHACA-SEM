 ...
 *   Galerkin approach.
 * - @subpage pageShallowWaterSolver - a solver for depth-integrated equations of shallow water type using either 
 *   a Continuous Galerkin or Discontinuous Galerkin approach.
...
/**
 * \page pageShallowWaterSolver ShallowWaterSolver
 *
