...
<test>
    ...
    <parameters>Test_ChanFlow2D_bcsfromfiles.xml</parameters>
    <files>
        <file description="Session File">Test_ChanFlow2D_bcsfromfiles.xml</file>
        <file description="Session File">Test_ChanFlow2D_bcsfromfiles_u_1.bc</file>
	<file description="Session File">Test_ChanFlow2D_bcsfromfiles_u_3.bc</file>
	<file description="Session File">Test_ChanFlow2D_bcsfromfiles_v_3.bc</file>
    </files>
    <metrics>
        <metric type="L2" id="1">
