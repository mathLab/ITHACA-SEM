...
<test>
    ...
    <metrics>
        <metric type="L2" id="1">
            <value variable="rho" tolerance="1e-12">42.82</value>
            <value variable="rhou" tolerance="1e-12">4.28351</value>
            <value variable="rhov" tolerance="1e-12">0.0819697</value>
            <value variable="E" tolerance="1e-12">5.23829</value>
        </metric>
