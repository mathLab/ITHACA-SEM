...
<test>
    ...
    <files>
     ...
     <metrics>
        <metric type="L2" id="1">
            <value variable="x" tolerance="1e-4">0.635168</value>
            <value variable="y" tolerance="1e-4">0.633921</value>
            <value variable="z" tolerance="1e-4">0.625</value>
            <value variable="u" tolerance="1e-4">0.5</value>
            <value variable="v" tolerance="1e-4">0</value>
            <value variable="w" tolerance="1e-4">0</value>
            <value variable="p" tolerance="1e-4">2.39818</value>
