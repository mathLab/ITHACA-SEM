...
\noindent{\textbf{LibUtilities:}}  This part of the library contains all the basic mathematical and computer science building blocks of the {\nek} code.
...
\noindent{\textbf{SpatialDomains:}} This part of the library contains the geometric information.  In particular, this part of the library deals with the basic mesh 
data structures, and the mapping information (just as Jacobians) from StdRegions to LocalRegions.

\noindent{\textbf{LocalRegions:}}  This part of the library contains objects that express ``local region'' data and operations.  Local regions are \shp elements in
...
\noindent{\textbf{Collections:}} This part of the library we amalgamate the action of key operators on multiple 
...
\noindent{\textbf{GlobalMapping:}} This part of the library holds the mapping data structures used to assemble local regions into multi-regions.

\noindent{\textbf{MultiRegions:}} This part of the library holds the data structures that represent sets of elements (local regions).  At the most fundamental 
...
\noindent{\textbf{NekMeshUtils:}} This part of the library contains various utilities are beneficial to our NekMesh efforts.

\noindent{\textbf{SolverUtils:}} This part of the library contains various utilities that aid in the pre- and post-processing tasks related to our solvers.

\noindent{\textbf{Timings:}} This part of the library contains various timing utilities.

\noindent{\textbf{UnitTests:}} This part of the library contains unit tests that allow us to test basic functionality within {\nek}.  These are useful for verifying
