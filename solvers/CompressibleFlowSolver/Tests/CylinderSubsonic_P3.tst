...
<test>
    ...
    <metrics>
        <metric type="L2" id="1">
            <value variable="rho" tolerance="1e-12">42.8281</value>
            <value variable="rhou" tolerance="1e-12">4.28471</value>
            <value variable="rhov" tolerance="1e-12">0.0813374</value>
            <value variable="E" tolerance="1e-12">5.23953</value>
        </metric>
