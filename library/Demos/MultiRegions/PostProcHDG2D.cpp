...
int main(int argc, char *argv[])
{
	...
	const LibUtilities::PointsKey PkeyQ1(num_points+1,LibUtilities::eGaussLobattoLegendre);
	const LibUtilities::PointsKey PkeyQ2(num_points+1,LibUtilities::eGaussLobattoLegendre);
	...
	BkeyQ.push_back(LibUtilities::BasisKey(LibUtilities::eModified_A, num_modes+1, PkeyQ1));
	BkeyQ.push_back(LibUtilities::BasisKey(LibUtilities::eModified_A, num_modes+1, PkeyQ2));
    ...
    if (vComm->GetRank() == 0)
    {
        cout << "Postprocessed solution:"  << endl;
        cout << "         No. modes  : " << num_modes << endl;
        cout << endl;
    }
