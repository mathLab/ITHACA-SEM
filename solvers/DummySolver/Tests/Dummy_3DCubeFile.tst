...
<test>
    ...
    <command>../DummySolver-g --verbose Dummy_3DCubeFile_0.xml mesh.cube.xml 1>output.out 2>output.err  & ../DummySolver-g --verbose Dummy_3DCubeFile_1.xml mesh.cube.xml 1>output1.out 2>output1.err &</command>
    <files>
