...
<test>
    ...
    <metrics>
        <metric type="L2" id="1">
            ...
            <value variable="ru" tolerance="1e-7"> 0.0175868</value>
            <value variable="rv" tolerance="1e-7"> 0.00688346</value>
        </metric>
        <metric type="Linf" id="2">
            <value variable="p" tolerance="1e-4">  13.659</value>
            <value variable="rho" tolerance="1e-12">0.000327788</value>
            <value variable="ru" tolerance="1e-7"> 0.0338246</value>
            <value variable="rv" tolerance="1e-7"> 0.0131226</value>
        </metric>
    </metrics>
</test>
