...
<FUNCTION NAME="FlowrateForce">
  ...
  <E VAR="ForceY" VALUE="1.0" />
  <E VAR="ForceZ" VALUE="1.0" />
</FUNCTION>
\end{lstlisting}

Optionally, the \inltt{IO\_FlowSteps} parameter can be defined, which produces a
file \inltt{session.prs} which records the value of $\alpha$ every
\inltt{IO\_FlowSteps} steps.
