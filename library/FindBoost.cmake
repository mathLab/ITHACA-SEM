...
ELSE (_boost_IN_CACHE)
  ...
  FOREACH(_boost_VER ${_boost_TEST_VERSIONS})
    IF( NOT Boost_INCLUDE_DIR )
      ...
      #MESSAGE(Testing)
      #MESSAGE(${_boost_INCLUDE_SEARCH_DIRS})
      #MESSAGE(${_boost_PATH_SUFFIX})
  ...
  ENDIF(WIN32)
  IF(_boost_ABI_TAG STREQUAL "g" )
       SET (_boost_ABI_TAG "${_boost_ABI_TAG}d")
  ELSE(_boost_ABI_TAG STREQUAL "g")
       SET(_boost_ABI_TAG "d")
  ENDIF(_boost_ABI_TAG STREQUAL "g")
