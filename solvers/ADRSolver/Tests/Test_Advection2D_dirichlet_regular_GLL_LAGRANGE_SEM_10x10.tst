...
<test>
    ...
    <parameters>Test_Advection2D_dirichlet_regular_GLL_LAGRANGE_SEM_10x10.xml</parameters>
    <files>
        <file description="Session File">Test_Advection2D_dirichlet_regular_GLL_LAGRANGE_SEM_10x10.xml</file>
    </files>
    <metrics>
        <metric type="L2" id="1">
