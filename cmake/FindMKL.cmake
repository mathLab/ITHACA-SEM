...
IF ( MKL_LAPACK_FOUND )
    ...
    SET (BLAS_LAPACK ${MKL} ${MKL_LAPACK} ${MKL_GUIDE} CACHE INTERNAL "Blas/lapack location")
ELSE (MKL_LAPACK_FOUND )
    ...
    SET (BLAS_LAPACK ${MKL_INTEL} ${MKL_SEQUENTIAL} ${MKL_CORE} CACHE INTERNAL "Blas/lapack location")
...
IF (LAPACK_FOUND )
        MESSAGE(STATUS "Found MKL: ${BLAS_LAPACK}")
ELSE()
