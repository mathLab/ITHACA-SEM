...
{
std::string __register_IProduct_Seg = GetOperatorFactory().RegisterCreatorFunction(
    std::string("IProduct_Seg_Regular"), &IProductSeg<>::Create);

std::string __register_IProduct_Seg_Deformed = GetOperatorFactory().RegisterCreatorFunction(
