...
<test>
    ...
    <parameters>Test_KovaFlow_m3.xml</parameters>
    <files>
        <file description="Session File">Test_KovaFlow_m3.xml</file>
	<file description="Session File">Test_KovaFlow_m3.rst</file>
    </files>
    <metrics>
        <metric type="L2" id="1">
