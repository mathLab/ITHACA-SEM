...
<test>
    ...
    <metrics>
        <metric type="L2" id="1">
            <value variable="u" tolerance="1e-10">6.13359e-09</value>
            <value variable="v" tolerance="1e-10">5.74846e-09</value>
            <value variable="p" tolerance="1e-8">1.37568e-07</value>
        </metric>
        <metric type="Linf" id="2">
            <value variable="u" tolerance="1e-10">1.02619e-07</value>
            <value variable="v" tolerance="1e-10">2.55204e-08</value>
