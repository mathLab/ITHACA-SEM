...
<test>
    ...
    <parameters>Test_2DFlow_lineforcing_bcfromfile.xml</parameters>
    <files>
        <file description="Session File">Test_2DFlow_lineforcing_bcfromfile.xml</file>
        <file description="Session File">Test_2DFlow_lineforcing_bcfromfile_u_1.bc</file>
    </files>
    <metrics>
        <metric type="L2" id="1">
