...
<test>
    ...
    <parameters>CylinderSubsonic_NS_WeakDG_LDG_VariableMu_par.xml</parameters>
    <processes>3</processes>
    <files>
        <file description="Session File">CylinderSubsonic_NS_WeakDG_LDG_VariableMu_par.xml</file>
    </files>
    <metrics>
        <metric type="L2" id="1">
        ...
        <metric type="Linf" id="2">
            ...
            <value variable="rhov" tolerance="1e-8">58.1854</value>
