...
<test>
    ...
    <metrics>
        ...
        <metric type="Linf" id="2">
            <value variable="rho" tolerance="1e-12">1.10853e-06</value>
            <value variable="rhou" tolerance="1e-12">2.86503e-06</value>
            <value variable="rhov" tolerance="1e-12">4.24074e-06</value>
            <value variable="rhow" tolerance="1e-12">0</value>
            <value variable="E" tolerance="1e-12">1.25246e-05</value>
        </metric>
    </metrics>
</test>
