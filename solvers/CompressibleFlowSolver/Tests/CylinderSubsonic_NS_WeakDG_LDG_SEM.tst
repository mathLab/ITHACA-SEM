...
<test>
    ...
    <metrics>
        <metric type="L2" id="1">
            ...
            <value variable="rhov" tolerance="1e-8">25.8706</value>
            <value variable="E" tolerance="1e-12">6.27025e+06</value>
        </metric>
        <metric type="Linf" id="2">
            <value variable="rho" tolerance="1e-12">0.531017</value>
            <value variable="rhou" tolerance="1e-12">92.5535</value>
            <value variable="rhov" tolerance="1e-8">58.442</value>
            <value variable="E" tolerance="1e-12">347066</value>
        </metric>
    </metrics>
</test>
