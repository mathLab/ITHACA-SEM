...
<test>
    ...
    <metrics>
        <metric type="L2" id="1">
            ...
            <value variable="rhou"  tolerance="1e-7">0.0019274</value>
            <value variable="rhov"  tolerance="1e-7">0.001952</value>
        </metric>
        <metric type="Linf" id="2">
            <value variable="p"   tolerance="1e-4">30.1506</value>
            <value variable="rho" tolerance="1e-12">8.06966e-06</value>
            <value variable="rhou"  tolerance="1e-7">0.00733383</value>
            <value variable="rhov"  tolerance="1e-7">0.0098123</value>
        </metric>
    </metrics>
</test>
