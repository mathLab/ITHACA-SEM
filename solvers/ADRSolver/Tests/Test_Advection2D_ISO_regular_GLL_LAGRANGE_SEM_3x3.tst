...
<test>
    ...
    <parameters>Test_Advection2D_ISO_regular_GLL_LAGRANGE_SEM_3x3.xml</parameters>
    <files>
        <file description="Session File">Test_Advection2D_ISO_regular_GLL_LAGRANGE_SEM_3x3.xml</file>
    </files>
    <metrics>
        <metric type="L2" id="1">
