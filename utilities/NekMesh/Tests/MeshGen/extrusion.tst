...
<test>
    ...
    <parameters>-m jac:list -m extrude:layers=1:length=0.1 extrusion.xml
        extrusion_3D.xml:xml:test:stats</parameters>
    <files>
        <file description="Input File">extrusion.xml</file>
    </files>
    <metrics>
