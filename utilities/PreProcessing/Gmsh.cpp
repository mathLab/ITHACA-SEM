...
{
//     const char* commentString = "Embed a 3-dimensional object in a 3-dimensional space";
//     const char* commentString = 0;
//     TiXmlComment * comment = new TiXmlComment();
//     cout << "Initializing comment" << endl;
...
//     exit(0);
    ...
    if(argc != 3)
    {
        fprintf(stderr,"Usage: ./Gmsh input(mesh)file output(xml)file\n");
        exit(1);
    }
    ...
    char* gmeshfile(argv[1]);
    char* outfile(argv[2]);
    ParseGmshFile(gmeshfile, outfile);
