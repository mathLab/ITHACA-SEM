...
<test>
    ...
    <metrics>
        <metric type="L2" id="1">
            ...
            <value variable="v" tolerance="1e-12">1.84102e-13</value>
            <value variable="p" tolerance="1e-8">5.92475e-10</value>
        </metric>
        <metric type="Linf" id="2">
            <value variable="u" tolerance="1e-12">5.93081e-13</value>
            <value variable="v" tolerance="1e-12">3.56319e-13</value>
