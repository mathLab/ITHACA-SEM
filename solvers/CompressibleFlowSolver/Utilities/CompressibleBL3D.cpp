	...
	Array <OneD, NekDouble >             T_QuadraturePts)
{
	...
	NekDouble eta, eta2, dd, dm, scale, flg, dlta, eta_v;
...
int main(int argc, char *argv[])
{
    ...
    // Filling the 3D expansion using a recursive
    ...
    // Definition of the name of the .fld file
    //string FalknerSkan = "resultat.fld";
