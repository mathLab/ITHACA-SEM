...
<test>
    ...
    <parameters>Test_Advection2D_periodic_deformed_GLL_LAGRANGE_SEM_2x2.xml</parameters>
    <files>
        <file description="Session File">Test_Advection2D_periodic_deformed_GLL_LAGRANGE_SEM_2x2.xml</file>
    </files>
    <metrics>
        <metric type="L2" id="1">
