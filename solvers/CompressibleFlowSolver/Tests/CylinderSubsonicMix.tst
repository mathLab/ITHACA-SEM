...
<test>
    ...
    <metrics>
        <metric type="L2" id="1">
            <value variable="rho" tolerance="1e-12">42.85</value>
            <value variable="rhou" tolerance="1e-12">4.28803</value>
            <value variable="rhov" tolerance="1e-12">0.0808728</value>
            <value variable="E" tolerance="1e-12">5.24283</value>
        </metric>
