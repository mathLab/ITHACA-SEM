...
SET(ACML_BASE_SEARCH_PATHS "/opt/acml" "C:\\Program Files\\AMD\\acml")
...
SET(ACML_VERSIONS 4.1.0 4.0.0 3.5.0 3.6.0 3.6.1)

SET(MP_COMPILER_VERSIONS gfortran64_mp gfortran64_mp_int64 pgi32_mp)
SET(COMPILER_VERSIONS gfortran64 gfortran64_int64 pgi32)
...
IF( ACML_USE_SHARED_LIBRARIES )
	IF( ACML_USE_OPENMP_LIBRARIES )
		SET(ACML_LIB_NAMES acml_mp)
	ELSE( ACML_USE_OPENMP_LIBRARIES )
		SET(ACML_LIB_NAMES acml)
	ENDIF( ACML_USE_OPENMP_LIBRARIES )
