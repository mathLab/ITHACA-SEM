...
<test>
    ...
    <parameters>Test_InviscidBurger1D_FRSD_GLL_LAGRANGE_SEM.xml</parameters>
    <files>
        <file description="Session File">Test_InviscidBurger1D_FRSD_GLL_LAGRANGE_SEM.xml</file>
    </files>
    <metrics>
        <metric type="L2" id="1">
