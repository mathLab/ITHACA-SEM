...
<test>
    ...
    <metrics>
        <metric type="L2" id="1">
            ...
            <value variable="u" tolerance="1e-12">0.0101436</value>
            <value variable="v" tolerance="1e-12">0.0106118</value>
        </metric>
        <metric type="Linf" id="2">
            <value variable="p" tolerance="1e-12">91.518</value>
            <value variable="u" tolerance="1e-12">0.0382706</value>
            <value variable="v" tolerance="1e-12">0.0381638</value>
        </metric>
    </metrics>
</test>
