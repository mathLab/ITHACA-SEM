...
int main(int argc, char *argv[])
{
    ...
    {      
        ...
        // First we will declare a variable F which will represent the rhs vector matrix. This is
        // an object of the class NekVector and can be allocated as follows:
        NekVector<NekDouble> F(nTotModes,0.0);
        // The elements of the mass matrix can now be accessed by the call F[i]
        ...
        Array<OneD, NekDouble> u_phys(nTotQuadPoints);
