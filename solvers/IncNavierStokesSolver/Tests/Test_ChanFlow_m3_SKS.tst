...
<test>
    <description>Channel Flow P=3 - Skew-Symmetric advection</description>
    <executable>IncNavierStokesSolver</executable>
    <parameters>Test_ChanFlow_m3_SKS.xml</parameters>
    <files>
        <file description="Session File">Test_ChanFlow_m3_SKS.xml</file>
    </files>
    <metrics>
        <metric type="L2" id="1">
